...
tf.flags.DEFINE_string("checkpoint_dir", "runs/1523195735/checkpoints", "Checkpoint directory from training run")
...
if FLAGS.eval_train:
    x_test, y_test = data_helpers.load_data_and_labels(FLAGS.data_file)
